...
func AllPlugins(silent, runnerOnly bool) {
	manifest, err := manifest.ProjectManifest()
	if err != nil {
		logger.Fatalf(true, err.Error())
	}
	installPluginsFromManifest(manifest, silent, runnerOnly)
}
...
func installPluginsFromManifest(manifest *manifest.Manifest, silent, runerOnly bool) {
